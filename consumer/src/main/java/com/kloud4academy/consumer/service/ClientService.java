...
//			String productApiUrl = "http://localhost:8083" + "/fetchProductsUsingCategory" + "/"+category;
...
//			return response;
//		}
		String productApiUrl = "http://localhost:8082" + "/nt-ms/fetchProductsUsingCategory" + "/"+category;
//		logger.info("---------Final Url " +productApiUrl );
		RestTemplate restTemplate = new RestTemplate();
		ResponseEntity<String> response = restTemplate.exchange(productApiUrl,HttpMethod.GET, getHeaders(),String.class);
		return response;
